/**
 * The JSON-RPC client the live quote source uses — re-exported from the calibrator's shared copy.
 *
 * The transport client lives exactly once, in `@bell/calibrator/adapters/rpc_client.js` (F112);
 * this file is the web's seam to it, kept so the adapter directory's shape is unchanged and a
